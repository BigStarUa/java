...
public class ScheduleDialog extends JDialog implements ActionListener{
	 ...
	 */
	public ScheduleDialog(Window owner, String title, ModalityType modalityType, Schedule schedule) throws ClassNotFoundException {
	...
	private void initContent()
	{
		...
		txtWeekDay.setBounds(96, 53, 164, 20);
		contentPanel.add(txtWeekDay);
